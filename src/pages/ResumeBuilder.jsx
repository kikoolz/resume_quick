...
const ResumeBuilder = () => {
  ...
  const loadExistingResume = async (resumeId) => {
    ...
    if (resume) {
      ...
      document.title = `Editing: ${resume.title} | Resume Quick`;
    }
  };
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              {/* Progressive bar using activeSectionIndex */}
              <hr className="absolute top-0 left-0 right-0 border-2 border-gray-200" />
              <hr
                className="absolute top-0 left-0 h-1 bg-linear-to-r from-green-400 to-green-600 border-none transition-all duration-2000 "
                style={{
                  width: `${
