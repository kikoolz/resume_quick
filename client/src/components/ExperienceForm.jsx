...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generatingDescription = async (index) => {
    try {
      ...
      const prompt = `enhance my job description "${experienceData[index].description}" for the position of ${experienceData[index].position} at ${experienceData[index].company}`;
