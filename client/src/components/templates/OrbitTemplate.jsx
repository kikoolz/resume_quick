...
const OrbitTemplate = ({ data, accentColor }) => {
  return (
    <div className="max-w-4xl mx-auto bg-white text-gray-800 leading-relaxed flex">
      ...
      <div className="w-1/3 p-6 bg-gray-100">
        {/* Contact Info */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-3 border-b border-gray-400 pb-1">
            Details
          </h3>
          <div className="space-y-2 text-sm">
            ...
            {data.personal_info?.location && (
              <div>
                <strong>Address:</strong> {data.personal_info.location}
              </div>
            )}
          </div>
        </div>
      ...
      <div className="w-2/3 p-6">
        ...
        {data.professional_summary && (
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3 border-b border-gray-400 pb-1">
              Summary
            </h2>
        ...
        {data.experience && data.experience.length > 0 && (
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-4 border-b border-gray-400 pb-1">
              Experience
            </h2>
